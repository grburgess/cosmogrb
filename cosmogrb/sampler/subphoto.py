...
from cosmogrb.sampler.subphoto_functions import (energy_integrated_evolution,
                                                 sample_energy, sample_events,
                                                 subphoto, subphoto_evolution,
...
class SubPhoto(SourceFunction):
    def __init__(
            self, K=1,  xi_b = 1e-6, r_i=1e11, r_0=1e7, gamma=400, l_grb=1e54, emin=10.0, emax=1e4, response=None,
    ):
        ...
        self._differential_flux = lambda x: subphoto(x, xi_b, r_i, r_0, gamma, l_grb, self._z)
